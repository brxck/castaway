...
throw new Error("Module build failed: SyntaxError: Unexpected token (84:39)\n\n  82 | \n  83 |   markListened() {\n> 84 |     const historyParams = { episode_id = this.data.get(\"episodeId\"),\n     |                                        ^\n  85 |                             podcast_id = this.data.get(\"podcastId\") }\n  86 |     Rails.ajax({\n  87 |       type: \"POST\",\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-86dfc7ed19b67779b41a.js.map