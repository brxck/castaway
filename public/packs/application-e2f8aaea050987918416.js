...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rails_ujs__ = __webpack_require__(/*! rails-ujs */ 30);
...
var context = __webpack_require__(/*! controllers */ 31);
  ...
  _createClass(_class, [{
    ...
    value: function initialize() {
      ...
      this.audioTarget.addEventListener("ended", function () {
        return _this2.markListened.bind(_this2);
      });
    }
  }, {
    key: "connect",
    ...
    value: function loadEpisode(e) {
      ...
      this.data.set("episodeId", e.target.dataset["episode-id"]);
      this.data.set("podcastId", e.target.dataset["podcast-id"]);
    ...
    value: function markListened() {
      ...
      // this.field.getElementByClassName("yes").classList.toggle("hidden", true)
      // this.field.getElementByClassName("no").classList.toggle("hidden", false)
    }
...
Object.defineProperty(_class, "targets", {
  enumerable: true,
  writable: true,
  value: ["audio", "toggle", "scrub", "volume", "speed", "time"]
});
/* harmony default export */ __webpack_exports__["default"] = (_class);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-e2f8aaea050987918416.js.map