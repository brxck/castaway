...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function initialize() {
      ...
      setInterval(this.markTime.bind(this), 10000);
    }
  }, {
    key: "connect",
    ...
    value: function disconnect() {
      clearInterval(this.scrubUpdater.bind(this));
      clearInterval(this.markTime.bind(this));
    }
  }, {
    key: "togglePlay",
    ...
    value: function markTime() {
      if (document.getElementById("signed-in") === null || this.audioTarget.currentTime === "0" || !this.loaded()) {
        return;
      }
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-1934d4dc4b61b406f51e.js.map