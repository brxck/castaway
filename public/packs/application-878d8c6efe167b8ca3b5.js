    ...
    value: function initialize() {
      ...
      if (this.data.get("lastPlayed") === "true" && this.loaded()) {
        this.audioTarget.addEventListener("loadedmetadata", function () {
          ...
          console.log(_this2.audioTarget.currentTime, _this2.data.get("lastTime") * _this2.audioTarget.seekable.end(0));
        });
      }
    }
  }, {
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-878d8c6efe167b8ca3b5.js.map