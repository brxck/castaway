...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stimulus__ = __webpack_require__(/*! stimulus */ 0);
...
var map = {
	"./listen_controller.js": 31,
	"./modal_controller.js": 32,
	"./navbar_controller.js": 33,
	"./player_controller.js": 34,
	"./sub_controller.js": 39
};
...
/* 31 */
/*!*********************************************************!*\
  !*** ./app/javascript/controllers/listen_controller.js ***!
  \*********************************************************/
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function initialize() {
      this.element.addEventListener("ajax:success", this.toggleListened.bind(this));

      this.element.addEventListener("ajax:failure", function (e) {
        return console.log("(un)subscribe failed", e);
      });
    }
  }, {
    key: "toggleListened",
    value: function toggleListened() {
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function initialize() {
      ...
      this.listenEvent = this.audioTarget.addEventListener("ended", this.markListened.bind(this));

      if (this.data.get("lastPlayed") === "true" && this.loaded()) {
        console.log("loading last played data");
        this.audioTarget.addEventListener("loadedmetadata", function () {
          _this2.audioTarget.currentTime = _this2.data.get("lastTime") * _this2.audioTarget.seekable.end(0);
          _this2.updateScrub(true);
        });
      }
    }
  }, {
    ...
    value: function setPosition() {
      this.audioTarget.currentTime = this.scrubTarget.value * this.audioTarget.seekable.end(0);
    }
  }, {
    key: "loadEpisode",
    value: function loadEpisode(e) {
      var _this3 = this;

      this.data.set("lastPlayed", "false");
      this.field = e.target.parentNode.parentNode;

      var episode = this.episodeFrom(e.currentTarget);
      ...
      this.audioTarget.addEventListener("metadataloaded", function (episode) {
        console.log("setting episode time", episode.time);
        _this3.audioTarget.currentTime = episode.time;
      });

      this.audioTarget.addEventListener("canplay", function () {
        _this3.audioTarget.play();
        _this3.setSpeed();
        _this3.updateButton();
      });
    }
    ...
    value: function seek(delta) {
      ...
      var startTime = this.audioTarget.seekable.start(0);
    ...
    key: "setNowPlaying",
    value: function setNowPlaying(episode) {
      ...
      if (document.getElementById("signed-in")) {
        ...
        var cookieParams = {
          cookie: {
            ...
            time_played: this.audioTarget.currentTime / this.audioTarget.seekable.end(0)
          }
        };
    ...
    key: "sendHistory",
    value: function sendHistory(params) {
    ...
    key: "sendCookie",
    value: function sendCookie(params) {
      var token = document.querySelector("meta[name=csrf-token]").content;
    ...
    key: "compileTemplate",
    value: function compileTemplate(template, locals) {
      var pug = __webpack_require__(/*! ../partials */ 35)("./" + template + ".pug");
      return pug(locals);
    }
    ...
    key: "updateScrub",
    value: function updateScrub(force) {
      if (force || this.playing() && this.loaded()) {
        this.scrubTarget.value = this.audioTarget.currentTime / this.audioTarget.seekable.end(0);

        this.timeTarget.textContent = this.formatTime(this.audioTarget.currentTime) + " / " + this.formatTime(this.audioTarget.seekable.end(0));
      }
    }
  }, {
    key: "formatTime",
    value: function formatTime(seconds) {
      return new Date(1000 * seconds).toISOString().substr(11, 8).replace(/^[0:]{3,4}/, "");
    }
  }]);
...
Object.defineProperty(_class, "targets", {
  enumerable: true,
  writable: true,
  value: ["audio", "toggle", "scrub", "volume", "speed", "time", "art", "episode", "podcast"]
});
/* harmony default export */ __webpack_exports__["default"] = (_class);
...
var pug = __webpack_require__(/*! ../../../node_modules/pug-runtime/index.js */ 37);
...
function pug_rethrow(err, filename, lineno, str){
  ...
  try {
    str = str || __webpack_require__(/*! fs */ 38).readFileSync(filename, 'utf8')
  } catch (ex) {
...
/* 39 */
/*!******************************************************!*\
  !*** ./app/javascript/controllers/sub_controller.js ***!
  \******************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    key: "initialize",
    value: function initialize() {
      this.element.addEventListener("ajax:success", this.toggleSubscription.bind(this));
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-f4f9afa58b44e20bef78.js.map