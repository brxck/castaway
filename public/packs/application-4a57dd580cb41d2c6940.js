...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function initialize() {
      ...
      document.body.addEventListener("ajax:success", this.toggleSubscription.bind(this));

      document.body.addEventListener("ajax:failure", function () {
        return _this2.buttonTarget.classList.toggle("is-danger", true);
      });
    }
  }, {
    key: "toggleSubscription",
    value: function toggleSubscription() {
      this.buttonTarget.classList.toggle("is-outlined");
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-4a57dd580cb41d2c6940.js.map