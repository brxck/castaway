...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function play() {
      ...
      setInterval(this.updateScrub, 500);
    }
  }, {
    key: "pause",
    value: function pause() {
      this.audioTarget.pause();
      clearInterval(this.updateScrub);
    }
  }, {
    key: "forward",
    ...
    value: function scrub() {
      this.audioTarget.currentTime = this.scrubTarget.value;
    }
  }, {
    key: "load",
    value: function load(e) {
      ...
      this.audioTarget.play();
      this.scrubTarget.max = this.audioTarget.seekable(0).max();
    ...
    value: function updateScrub() {
      this.scrubTarget.value = this.audioTarget.currentTime;
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-e6694552bca23762847c.js.map