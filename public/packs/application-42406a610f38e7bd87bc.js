...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    key: "push",
    value: function push(episode) {
      this.playlist.push(episode);
      this.playlistTarget.insertAdjacentHTML("beforeend", this.render("playlist_entry", { episode: episode }));
    }
  }, {
    key: "unshift",
    value: function unshift(episode) {
      this.playlist.unshift(episode);
      this.playlistTarget.insertAdjacentHTML("afterbegin", this.render("playlist_entry", { episode: episode }));
    }
  }, {
    key: "render",
    value: function render(template, locals) {
      var pug = __webpack_require__(/*! ../partials */ 32)("./" + template + ".pug");
      return pug(locals);
    }
  }, {
    key: "episodeFrom",
...
var pug = __webpack_require__(/*! ../../../node_modules/pug-runtime/index.js */ 34);
...
function pug_rethrow(err, filename, lineno, str){
  ...
  try {
    str = str || __webpack_require__(/*! fs */ 35).readFileSync(filename, 'utf8')
  } catch (ex) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-42406a610f38e7bd87bc.js.map