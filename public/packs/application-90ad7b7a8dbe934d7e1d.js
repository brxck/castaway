...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function setNowPlaying(episode) {
      ...
      this.episodeTarget.href = "/podcasts/" + episode.podcastId + "?episode_id=" + episode.episodeId;
    }
  }, {
    key: "updateButton",
...
Object.defineProperty(_class, "targets", {
  enumerable: true,
  writable: true,
  value: ["audio", "toggle", "scrub", "volume", "speed", "time", "art", "episode", "podcast", "artLink"]
});
/* harmony default export */ __webpack_exports__["default"] = (_class);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-90ad7b7a8dbe934d7e1d.js.map