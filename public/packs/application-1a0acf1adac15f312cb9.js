...
throw new Error("Module build failed: SyntaxError: Unexpected token (83:39)\n\n  81 | \n  82 |   markListened() {\n> 83 |     const historyParams = { episode_id = this.data.get(\"episodeId\"),\n     |                                        ^\n  84 |                             podcast_id = this.data.get(\"podcastId\") }\n  85 |     Rails.ajax({\n  86 |       type: \"POST\",\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-1a0acf1adac15f312cb9.js.map