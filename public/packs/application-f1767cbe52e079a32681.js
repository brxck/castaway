...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function speed() {
      var currentSpeed = parseInt(this.speedTarget.value);
      if (currentSpeed < 0) {
    ...
    value: function faster() {
      if (this.speedTarget.value <= 1.75) {
        this.speedTarget.value = parseInt(this.speedTarget.value) + 0.25;
      } else {
        this.speedTarget.value = 2;
      }
    }
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-f1767cbe52e079a32681.js.map