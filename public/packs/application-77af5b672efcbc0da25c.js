...
var map = {
	...
	"./navbar_controller.js": 32,
	"./player_controller.js": 33,
	"./scroll_controller.js": 38,
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function loadEpisode(e) {
      ...
      var episode = this.episodeFrom(e.target);
    ...
    value: function compileTemplate(template, locals) {
      var pug = __webpack_require__(/*! ../partials */ 34)("./" + template + ".pug");
      return pug(locals);
    }
...
var pug = __webpack_require__(/*! ../../../node_modules/pug-runtime/index.js */ 36);
...
function pug_rethrow(err, filename, lineno, str){
  ...
  try {
    str = str || __webpack_require__(/*! fs */ 37).readFileSync(filename, 'utf8')
  } catch (ex) {
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function scroll(e) {
      console.log("scroll");
      var amount = parseInt(this.viewTarget.clientWidth);
      if (e.currentTarget.dataset.dir === "left") {
        amount = 0 - amount;
      }
      amount = amount - amount % this.viewTarget.firstChild.offsetWidth;
      this.viewTarget.scrollLeft = parseInt(this.viewTarget.scrollLeft) + amount;
      this.updateButtonVisibility();
    }
  }, {
    key: "updateButtonVisibility",
    value: function updateButtonVisibility() {
      if (this.viewTarget.scrollLeft === 0) {
        this.leftTarget.classList.toggle("hidden", true);
      } else if (this.viewTarget.scrollLeft === this.viewTarget.scrollWidth) {
        this.rightTarget.classList.toggle("hidden", true);
      } else {
        this.leftTarget.classList.toggle("hidden", false);
        this.rightTarget.classList.toggle("hidden", false);
      }
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-77af5b672efcbc0da25c.js.map