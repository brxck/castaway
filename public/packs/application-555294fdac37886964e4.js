...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function play(e) {
      if (is_playing) {
        this.enqueue(this.nowPlayingTarget.firstChild);
        this.nowPlayingTarget.firstChild.remove();
      }
      this.nowPlayingTarget.appendChild(e.target.cloneNode);

      this.audioTarget.src = e.target.dataset.audio;
      this.episodeTarget.textContent = e.target.dataset.episode;
      this.podcastTarget.textContent = e.target.dataset.podcast + " - " + e.target.dataset.date;
      this.audioTarget.play();
...
Object.defineProperty(_class, "targets", {
  enumerable: true,
  writable: true,
  value: ["audio", "toggle", "source", "now-playing", "playlist"]
});
/* harmony default export */ __webpack_exports__["default"] = (_class);

/***/ })
/******/ ]);
//# sourceMappingURL=application-555294fdac37886964e4.js.map