...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    key: "enqueuePlaying",
    value: function enqueuePlaying(episode) {
      this.playlist.push(episode);
      var entryTemplate = __webpack_require__(/*! ../partials/playlist_entry.pug */ 32);
      this.playlistTarget.insertAdjacentHTML("beforeend", entryTemplate({ episode: episode }));
    }
  }, {
    key: "enqueue",
...
Object.defineProperty(_class, "targets", {
  enumerable: true,
  writable: true,
  value: ["audio", "toggle", "source", "playlist"]
});
...
var pug = __webpack_require__(/*! ../../../node_modules/pug-runtime/index.js */ 33);

function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (episode) {pug_html = pug_html + "\u003Cmixin episode\u003E\u003C\u002Fmixin\u003E\u003Cdiv" + (pug.attr("data-episode", episode.episode, true, true)+pug.attr("data-podcast", episode.podcast, true, true)+pug.attr("data-date", episode.date, true, true)+pug.attr("data-audio", episode.audio, true, true)) + "\u003E\u003Cdiv id=\"episode\"\u003E= episode.episode\u003C\u002Fdiv\u003E\u003Cdiv id=\"podcast\"\u003E= episode.podcast\u003C\u002Fdiv\u003E\u003Cdiv id=\"date\"\u003E= episode.date\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"episode" in locals_for_with?locals_for_with.episode:typeof episode!=="undefined"?episode:undefined));;return pug_html;};
...
function pug_rethrow(err, filename, lineno, str){
  ...
  try {
    str = str || __webpack_require__(/*! fs */ 34).readFileSync(filename, 'utf8')
  } catch (ex) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-bead1823209682904641.js.map