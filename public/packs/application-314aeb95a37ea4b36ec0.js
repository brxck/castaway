...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function initialize() {
      ...
      console.log(this.audioTarget.seekable.end(0), "hello");

      if (this.data.has("lastPlayed")) {
        this.audioTarget.currentTime = this.data.get("lastTime") * this.audioTarget.seekable.end(0);
      }
    }
  }, {
    key: "connect",
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-314aeb95a37ea4b36ec0.js.map