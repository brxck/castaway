...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function speed() {
      var newSpeed = parseInt(this.speedTarget.value, 10);
      if (newSpeed < 0) {
    ...
    value: function faster() {
      var currentSpeed = parseInt(this.speedTarget.value, 10);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-5174dd55214aec3a734d.js.map