...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function playEpisode(e) {
      ...
      if (this.nowPlaying !== nil) {
        this.enqueue(this.nowPlaying);
      }

      this.data.set("episode", e.target.dataset.episode);
      this.data.set("podcast", e.target.dataset.podcast);
      this.data.set("date", e.target.dataset.date);
      this.data.set("audio", e.target.dataset.audio);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-95b9e358bfcc6f5055a5.js.map