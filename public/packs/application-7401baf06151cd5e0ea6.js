...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function setNowPlaying(episode) {
      ...
      this.episodeTarget.href = "/podcasts/" + episode.podcast_id + "?episode_id=" + episode.episode_id;
      this.episodeTarget.textContent = episode.episode;
      this.podcastTarget.href = "/podcasts/" + episode.podcast_id;
    ...
    value: function keyboardShortcut(e) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-7401baf06151cd5e0ea6.js.map