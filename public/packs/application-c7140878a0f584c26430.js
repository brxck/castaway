...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    value: function setSpeed() {
      var newSpeed = parseFloat(this.speedTarget.value, 10);
      if (newSpeed < 0) {
    ...
    value: function increaseSpeed() {
      var currentSpeed = parseFloat(this.speedTarget.value, 10);
...
Object.defineProperty(_class, "targets", {
  enumerable: true,
  writable: true,
  value: ["audio", "toggle", "scrub", "volume", "speed"]
});
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-c7140878a0f584c26430.js.map